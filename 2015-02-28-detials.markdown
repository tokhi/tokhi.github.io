...
<img src="http://stackoverflow.com/users/flair/277740.png" width="208" height="58" alt="profile for tokhi at Stack Overflow, Q&amp;A for professional and enthusiast programmers" title="profile for tokhi at Stack Overflow, Q&amp;A for professional and enthusiast programmers">
</a>
...
* Database-driven web applications via Ruby, Ruby on Rails, Python (Flask & bottle), nodejs (expressjs framework), Vue.js, React, Sinatra, Padrino, Cucumber, Rspec, Resque, Redis
...
* Travis, codeship
* Vagrant, chef, Puppet, Apache, cacti, squid, Nginx, Docker, Kubernetes, Gitlab-CI/CD, Heroku apps, AWS
...
* Databases: Postgresql, Mysql, ElasticSearch, Kibana, MongoDB, GraphQL, sqlite3

* Favorite IDE – Vim, Sublime, Atom, Eclipse, PyCharm, IntelliJ, Textmate

* Project Management – Initiation , planning, problem solving.

* Special skills in Linux: (10 years) working experience with different distributions.

* Huge fan of Kubernetes, docker containers and shell scripting

* Working experience in Jira, Asana, Kanban, Trello, Newrelic, Sentry, hipchat, hubot and slack.
...
<hr>
* September 2017 - November 2019 _Development Team Lead_ at <em>DigitaleSeiten GmbH, Berlin - Germany<em>
* October 2015 - August 2017 _Senior Full Stack Developer_ at <em>DigitaleSeiten GmbH, Berlin - Germany<em>, building RESTful APIs, lead distribution systems, CRM and 22 ruby on rails web platforms.
* January, 2014 - September 2015 _Senior Full Stack Developer & team lead_ at <em>Castaclip GmbH, Potsdam - Germany<em> , working primarily with Ruby, Python and Java with teams consisting of 15 software Developers and test engineers
* January, 2013 - December 2013, _Java & Ruby Developer_ at <em>Castaclip GmbH, Potsdam - Germany<em> as a freelancer
* October, 2013 - December, 2013, Project Manager of the PEMS ( Patient Emergency and Management System based on Java) in Herat Regional Hospital.
* January, 2013 - December, 2013,  Software Engineering Lecturer ( Herat University – Computer Science Faculty ).
* October, 2012 - December, 2012, Herat University Network Operation Center Manager
* April, 2012 - September, 2012, Senior Developer at Afghan Citadel Software Company 
...
* March, 2011 - March, 2012, IT Manager in Herat University (IT Center)
...
* March, 2010 - Feb, 2011, Teaching Software Engineering concepts and programming.
...
* Jan, 2007 – June 2007, AIHRC – IT Coordinator and Manager Secretary (Human rights Commision – Herat, Afghanistan )

* April 2006 – Oct 2006,  FMFB – Database Officer
