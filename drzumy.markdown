...
Localtion: <em> 📍 Berlin, Germany · 💼 EU Work Permit </em>
...
<hr>
Highly competent DevOps & Platform Engineer with over 12 years’ development experience across a variety of platforms - building, automating, and scaling infrastructure and developer platforms. Strong background in backend development (Ruby, Java, Python) combined with expertise in Kubernetes, cloud infrastructure, observability, and infrastructure as code.
I specialize in designing reliable and secure platforms that enable product teams to move fast without sacrificing stability or scalability.
<br>
...
<hr>
* <b>Platform & Cloud:</b> AWS, GCP, Kubernetes, Helm, Terraform, Ansible, ArgoCD, GitLab CI/CD, Docker
...
* Travis, codeship
* Kubernetes, Vagrant, chef, Puppet, Apache, cacti, squid, Nginx, Docker, Kubernetes, Gitlab-CI/CD, Helm, Heroku apps, AWS
...
* IDEs – Vim, Visual Studio, Sublime, Atom, Eclipse
...
* Kubernetes, Infrastructre as code (Terraform), Helm charts, Helmfile, docker containers and shell scripting
...
* _DevOps & Platform Engineer_ at <em>Mediafellows GmbH, Berlin - Germany<em>
  ...
  * Containerized Ruby and Python applications and deployed them to early-stage Kubernetes clusters.
  * Implemented CI/CD pipelines, automated testing, and zero-downtime deployment strategies.
  * Optimized infrastructure cost and performance by introducing autoscaling and efficient resource usage.
  * Provided incident response and on-call support for production systems, ensuring high uptime.
  * Supported and mentored development teams on DevOps tooling and practices.
* _Senior Software Engineer / SRE_ at <em>Aroundhome GmbH, Berlin - Germany<em>
  * Designed and maintained highly available backend systems while implementing SRE best practices, including monitoring, alerting, and automated incident response.
