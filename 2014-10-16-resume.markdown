...
* Database-driven web applications via Ruby, Ruby on Rails, Go, Gin, Go Fiber, Python (Flask & bottle), nodejs (expressjs framework), Vue.js, React, Sinatra, Padrino, Cucumber, Rspec, Resque, Redis
