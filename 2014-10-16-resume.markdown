...
* Travis, codeship
* Vagrant, chef, Puppet, Apache, cacti, squid, Nginx, Docker
...
* Huge fan of docker containers and shell scripting
...
* _Senior Full Stack Developer_ at <em>DigitaleSeiten GmbH, Berlin - Germany<em>, building RESTful APIs, lead distribution systems, CRM and ruby on rails web platforms.
