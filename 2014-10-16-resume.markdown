...
* Database-driven web applications via Ruby, Ruby on Rails, Go, Gin, Go Fiber, Python (Flask & bottle), PHP, nodejs (expressjs framework), Vue.js, React, Sinatra, Padrino, Cucumber, Rspec, Minitest, Resque and Redis
...
* IDEs – Vim, Visual Studio, Sublime, Atom, Eclipse, PyCharm, IntelliJ, Textmate
...
###### April 2006 - 2024 ######
<hr>
* _Senior Backend Software Engineer_ at <em>Mediafellows GmbH, Berlin - Germany<em>
* _Senior Backend Software Engineer_ at <em>Aroundhome GmbH, Berlin - Germany<em>
